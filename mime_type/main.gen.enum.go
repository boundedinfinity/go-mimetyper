...
var (
	All = []MimeType{
		...
		TextXCue,
		ApplicationXGo,
		ApplicationXGoTemplate,
		ApplicationXCpp,
		ApplicationXCsharp,
		ApplicationXPython,
		ApplicationXPythonGenerated,
		ApplicationXRuby,
		ApplicationXRust,
		ApplicationXBnf,
		ApplicationXAbnf,
		ApplicationXVisualBasic,
		ApplicationXSass,
		ApplicationXDart,
		ApplicationXBash,
		ApplicationXFish,
		...
		ApplicationXXtend,
		ApplicationXXquery,
		ApplicationXWebassembly,
		ApplicationXSql,
		ApplicationXR,
		ApplicationXPowershell,
		ApplicationXPerl,
		ApplicationXObjectiveC,
		ApplicationXCHeader,
		ApplicationXLua,
		ApplicationXGuile,
		ApplicationXFortran,
		ApplicationXForth,
		ApplicationXMarkdown,
		ApplicationXNunjucks,
		ApplicationXHandlebars,
		ApplicationXEjs,
		ApplicationXMustache,
		ApplicationXHaml,
		ApplicationXPug,
		ApplicationXLiquid,
		ApplicationXWebc,
...
func Parse(v string) (MimeType, error) {
	f, ok := slicer.FindFn(func(x MimeType) bool {
		return MimeType(v) == x
	}, All...)
...
func Is(s string) bool {
	return slicer.ContainsFn(func(v MimeType) bool {
		return string(v) == s
	}, All...)
}
